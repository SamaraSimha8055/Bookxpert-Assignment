...
class GetNavigationActivity : AppCompatActivity() {

    private val LOCATION_PERMISSION_REQUEST_CODE = 120
        ...
        fusedLocationClient.lastLocation
            .addOnSuccessListener { location: Location? ->
                location?.let {
                    ...
                    // Use the location
                    findViewById<TextView>(R.id.locationCoordinates).setText("Latitude : " + latitude + " Longitude : " + longitude)
                }
            }
    }
}